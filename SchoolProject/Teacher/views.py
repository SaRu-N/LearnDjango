...
def stuform(request):
  if request.method =='POST':
    ...
    if fm.is_valid():
      ...
      messages.add_message(request,messages.SUCCESS,'Your Form has been submitted Successfully!')
  ...
  return render(request, 'teacher/stuReg.html', {"fm":fm})
...
def teacherform(request):
  if request.method=='POST':
    ...
    if fm.is_valid():
      ...
      fm=TeacherRegistration()
  return render(request, 'teacher/teacherReg.html', {"fm":fm})